                    ...
                    <div class="card card-body bg-success-400 has-bg-image">
                        <div class="media">
                            <div class="media-body ">
                                <h3 class="mb-0">{{$expired_premiums_salary * 0.20?? ''}}  @lang('app.shekel')</h3>
                                <span class="text-uppercase font-size-xs font-weight-bold">@lang('app.expired_premiums_salary_in_six_month')</span>
                            </div>
